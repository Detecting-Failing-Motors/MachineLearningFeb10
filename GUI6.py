...
Ui_MainWindow, QMainWindow = loadUiType('MQAAdraft4_2.ui')
...
class Main(QMainWindow, Ui_MainWindow):
 ...
 ##############################################       
    ...
    def run(self,): #called when run is clicked
        ...
        splot5info,plot6info,plot7info,plot8info,plot9info = getGraphs(AllData)
        
        self.getPlot(self.sub0,plot0info)
        self.getPlot(self.sub1,plot1info)
        self.getPlot(self.sub2,plot2info)
        self.getPlot(self.sub3,plot3info)
        self.getPlot(self.sub4,plot4info)
